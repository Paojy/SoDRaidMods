...
TransFrame.Icon = TransFrame:CreateTexture(nil, "OVERLAY", nil, 1)
...
NoTransFrame.Icon = NoTransFrame:CreateTexture(nil, "OVERLAY", nil, 1)
...
Timeline.CreateBar = function(ind, str, exp_time, row_time)
	...
	frame.tex = frame:CreateTexture(nil, "OVERLAY", nil, 1)
