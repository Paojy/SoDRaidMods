...
TransFrame.Icon = TransFrame:CreateTexture(nil, "OVERLAY")
...
NoTransFrame.Icon = NoTransFrame:CreateTexture(nil, "OVERLAY")
...
DSFrame.CreateIcon = function(cd_type, arg1, ind)
	...
	frame.texture = frame:CreateTexture(nil, "BORDER", nil)
...
T.CreateAlertIcon = function(v, hl, index, tip, r, g, b, role)
	...
	frame.role_text = T.createtext(frame.role_btn, "OVERLAY", 10, "OUTLINE", "CENTER")
...
local function CreateIcon(parent, tag)
	...
	button.icon = button:CreateTexture(nil, "OVERLAY", nil)
	button.icon:SetPoint("TOPLEFT",button,"TOPLEFT", 1, -1)
	button.icon:SetPoint("BOTTOMRIGHT",button,"BOTTOMRIGHT",-1, 1)
	button.icon:SetTexCoord(.08, .92, 0.08, 0.92)
	
	button.overlay = button:CreateTexture(nil, "ARTWORK", nil)
	button.overlay:SetTexture("Interface\\Buttons\\WHITE8x8")
	button.overlay:SetAllPoints(button)	
	
	button.bd = button:CreateTexture(nil, "ARTWORK", nil)
	...
	if strfind(tag, "spells") then
		...
		button.cast.icon = button.cast:CreateTexture(nil, "OVERLAY", nil)
		...
		button.cast.overlay = button.cast:CreateTexture(nil, "ARTWORK", nil)
